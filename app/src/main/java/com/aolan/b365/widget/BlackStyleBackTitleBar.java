...
import com.aolan.b365.utils.CommonUtils;
...
public class BlackStyleBackTitleBar extends Toolbar implements View.OnClickListener {
        ...
        if (attrs != null) {
            ...
            try {
                ...
                if (showBack) {
                    ...
                    int ivBackRes = a.getResourceId(R.styleable.BackTitleBar_backIcon, 0);
                    if (ivBackRes != 0) {
                ...
                if (actionBg != 0) {
                    ...
                    lp.setMargins(0, 0, CommonUtils.convertDIP2PX(context, 10), 0);
                } else {
                ...
                int textColor = a.getColor(R.styleable.BackTitleBar_titleTextColor, getResources().getColor(R.color.black));
                ...
                if (background != 0) {
                    ...
                    //setBackgroundResource(R.drawable.bg_mine);
                }
            } finally {
                a.recycle();
            }
    ...
    public void setIvBack(int actionRes) {
        ivBack.setImageResource(actionRes);
    }
